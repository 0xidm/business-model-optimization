...
def test_buybacks(business_model):
    ...
    assert business_model.buybacks(month=2) == approx(7_131, rel=0.01)
    assert business_model.buybacks(month=3) == approx(7_240, rel=0.01)
    assert business_model.buybacks(month=4) == approx(7_396, rel=0.01)
...
def test_treasury_yield_on_yield(business_model):
    ...
    assert business_model.treasury_yield_on_yield(month=2) == approx(16_677, rel=0.01)
    assert business_model.treasury_yield_on_yield(month=3) == approx(16_769, rel=0.01)

def test_net_new_pol(business_model):
    assert business_model.net_new_pol(month=1) == 1_000
    assert business_model.net_new_pol(month=2) == approx(17_827, rel=0.01)
    assert business_model.net_new_pol(month=3) == approx(18_099, rel=0.01)
    assert business_model.net_new_pol(month=4) == approx(18_489, rel=0.01)
...
def test_new_credit_lines(business_model):
    ...
    assert business_model.new_credit_lines(month=4) == approx(15_914, rel=0.01)
...
def test_cost_of_lp(business_model):
    assert business_model.cost_of_lp(month=1) == approx(-5_155, rel=0.01)
    assert business_model.cost_of_lp(month=2) == approx(1_409, rel=0.01)
    assert business_model.cost_of_lp(month=3) == approx(1_346, rel=0.01)
...
def test_total_treasury(business_model):
    ...
    assert business_model.total_treasury(month=2) == approx(1_006_141, rel=0.01)
    assert business_model.total_treasury(month=3) == approx(1_018_409, rel=0.01)

def test_surplus(business_model):
    assert business_model.surplus(month=1) == approx(-5_155, rel=0.02)
    assert business_model.surplus(month=2) == approx(1_409, rel=0.15)
    assert business_model.surplus(month=3) == approx(1_346, rel=0.15)
    assert business_model.surplus(month=11) == approx(1_325, rel=0.15)
    assert business_model.surplus(month=12) == approx(1_302, rel=0.15)

def test_tvl(business_model):
    assert business_model.final_deposits == approx(3762180, rel=0.1)
    assert business_model.final_sages == approx(902446, rel=0.1)
    assert business_model.final_treasury == approx(1837206, rel=0.1)
    assert business_model.final_tvl == approx(6761670, rel=0.1)
...
def test_cost_of_lp(business_model):
    ...
    assert business_model.cost_of_lp(month=1) == approx(5555, rel=0.1)
    assert business_model.cost_of_lp(month=2) == approx(5722, rel=0.1)
    assert business_model.cost_of_lp(month=3) == approx(5894, rel=0.1)

def test_finals(business_model):
    assert business_model.final_treasury == approx(1_837_207, rel=0.01)
    assert business_model.final_deposits == approx(4_011_895, rel=0.07)
    assert business_model.final_sages == approx(912_569, rel=0.02)
    assert business_model.final_tvl == approx(6_761_670, rel=0.04)

def test_finals_2(business_model_2):
    assert business_model_2.final_treasury == approx(3_133_069, rel=0.01)
    assert business_model_2.final_deposits == approx(104_146_265, rel=0.01)
    assert business_model_2.final_sages == approx(8_174_117, rel=0.01)
    assert business_model_2.final_tvl == approx(114_644_998, rel=0.01)
